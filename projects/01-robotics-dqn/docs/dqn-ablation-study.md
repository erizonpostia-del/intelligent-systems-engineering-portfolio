...
Run-level, paired-comparison, factorial-effect, and efficiency CSVs are in `results/dqn/algorithm-ablation/`. Figures in `figures/dqn/algorithm-ablation/` are derived from those CSVs.
