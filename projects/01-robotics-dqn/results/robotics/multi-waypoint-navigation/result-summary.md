...
`figures/robotics/ros1/ros1_nine_goal_terminal_evidence_redacted.png` preserves the `Goal 1 reached` through `Goal 9 reached` lines and `World outer loop finished`.
