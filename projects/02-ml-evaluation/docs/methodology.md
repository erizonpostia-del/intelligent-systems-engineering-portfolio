...
The outer-fold mean summarizes error across this simulated configuration. Its sample standard deviation describes variation among five folds, not uncertainty over every possible dataset or a claim about real deployment. These results show how the evaluation workflow behaves under this setup. They do not show that one regularizer is generally better, identify real features, or support a deployment-performance claim.
