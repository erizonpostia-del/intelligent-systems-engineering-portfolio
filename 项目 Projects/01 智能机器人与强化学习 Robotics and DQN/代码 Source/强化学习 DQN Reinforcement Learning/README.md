...
If you adapt these components for a new experiment, use a new output directory, a new run identifier, and separate validation and test seed manifests. Do not write into `结果 Results` or `图表 Figures`, which are published result artifacts.
