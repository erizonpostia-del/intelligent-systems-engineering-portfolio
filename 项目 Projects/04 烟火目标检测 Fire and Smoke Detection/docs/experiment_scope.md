...
This portfolio project is an evidence-led report of archived YOLO11 fire-and-smoke detection experiments under different training conditions. It concerns a five-class forest-monitoring setting: fire and smoke are the central safety-relevant categories, while animal, person, and vehicle capture broader scene content.
